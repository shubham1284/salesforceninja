      ...
      <div className="footer-inner">
        <div>
          ...
          <p className="footer-tagline">
            Premium Salesforce solutions by a certified developer for businesses
            that demand quality, security, and reliability in their Salesforce
            org.
          </p>
        </div>
        <div>
          ...
          <ul className="footer-links">
            <li>
              <a href="#">LWC Components</a>
            </li>
            <li>
              <a href="#">SSO Integrations</a>
            </li>
            <li>
              <a href="#">Automation Tools</a>
            </li>
            <li>
              <a href="#">Data Utilities</a>
            </li>
          </ul>
        </div>
        <div>
