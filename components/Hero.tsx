...
const metrics = [
  ...
  { icon: "✦", iconClass: "ic-s", num: "3+",  label: "Years of Expertise" },
        ...
        <div className="hero-inner">
          ...
          <div>
            <div className="hero-eyebrow fade-up visible">
              ...
              <span className="eyebrow-text">Salesforce AppExchange Certified Developer</span>
            </div>
            <h1 className="hero-h1 fade-up visible d1">
              Premium<br />
              <span className="h1-italic">Salesforce</span><br />
            ...
            <p className="hero-desc fade-up visible d2">
              Production-ready Lightning Web Components, SSO integrations, automation tools
              and data utilities — crafted for enterprise Salesforce orgs that demand quality.
            </p>
            <div className="hero-btns fade-up visible d3">
              <a href="#products" className="btn-gold">Explore Solutions →</a>
              <a
                href={DEMO_LINK}
                target="_blank"
